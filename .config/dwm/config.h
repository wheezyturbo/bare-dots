...
static const char *dmenucmd[] = { "dmenu_run", "-i", "-c", "-l", "8", "-h", "38", "-bw", "3", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_fg, "-sb", col_sel, "-sf", col_bg, "-nhf", "#E6C384", "-nhb", col_bg, "-shf", "#E6C384", "-shb", col_sel, NULL };
